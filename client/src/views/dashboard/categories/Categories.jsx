...
export default function Categories() {
    ...
    return (
        <Layout>
            <h2 className='my-4 fw-bold' style={{ color: 'blueviolet'}}>Categories</h2>
                        ...
                        return (
                            <li key={category.id} className="list-group-item">
                                ...
                                <span className='text-secondary fw-semibold'>added by @
                                    <Link 
                                        to={ route('dashboard.authors.show', { id: category.added_by }) }>
                                        <span style={{color: 'blueviolet'}}>{category.added_by}</span>
                                    </Link> | {dayjs(category.created_at).format('MMM D, YYYY')}
                                    {/* | {intlFormat(new Date(category.created_at), {
                                                    year: 'numeric',
                                                    month: 'short',
                                                    day: 'numeric',
                                                })} */}
