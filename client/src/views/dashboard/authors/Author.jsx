    ...
    return (
        <Layout>
            <div className="container-fluid w-100 my-4">
                ...
                <h2 className='mb-4 fw-bold'><span style={{ color: 'blueviolet'}}>{ (author.data.first_name || author.data.last_name) ? author.data.first_name + ' ' + author.data.last_name : '(User is yet to provide their name)' }</span></h2>

                <section className="container-fluid card rounded-0 shadow py-4">
                    ...
                    <p className="fw-semibold text-secondary fs-6 mb-3 text-end">Joined | {dayjs(author.data.created_at).format('MMM D, YYYY')}
                    </p>
                    
                    <p className="text-secondary fs-6 mb-3"> 
                        <span style={{ color: 'blueviolet'}}>Username:</span>
                        <span className='fs-5'> {author.data.username}</span>
                        
                    </p>
                    
                    <h3 className='fs-5' style={{ color: 'blueviolet'}}>Bio:</h3>
