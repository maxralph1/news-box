                ...
                <div className="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                    <ul className="nav flex-column">
                        <li className="nav-item">
                            <Link to={route('dashboard')} className="nav-link d-flex align-items-center gap-2 active" aria-current="page" href="#">
                        ...
                        <li className="nav-item">
                            <Link to={route('dashboard.categories.index')} className="nav-link d-flex align-items-center gap-2" href="#">
                        ...
                        <li className="nav-item">
                            <Link to={route('dashboard.sub-categories.index')} className="nav-link d-flex align-items-center gap-2" href="#">
                        ...
                        <li className="nav-item">
                            <Link to={route('dashboard.articles.index')} className="nav-link d-flex align-items-center gap-2" href="#">
                        ...
                        <li className="nav-item">
                            <Link to={route('dashboard.authors.index')} className="nav-link d-flex align-items-center gap-2" href="#">
