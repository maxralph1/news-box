    ...
    return (
        <div className="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
            <div className="offcanvas-md offcanvas-end bg-body-tertiary" tabIndex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                ...
                <h5 className="offcanvas-title" id="sidebarMenuLabel">News-Box</h5>
                <button type="button" className="btn-close" data-bs-dismiss="offcanvas" data-bs-target="#sidebarMenu" aria-label="Close"></button>
                </div>
                <div className="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                    <ul className="nav flex-column">
                        <li className="nav-item">
                            <Link to={route('dashboard')} className="nav-link d-flex align-items-center gap-2 text-dark active" aria-current="page">
                        ...
                        <li className="nav-item">
                            <Link to={route('dashboard.categories.index')} className="nav-link d-flex align-items-center gap-2 text-dark">
                        ...
                        <li className="nav-item">
                            <Link to={route('dashboard.sub-categories.index')} className="nav-link d-flex align-items-center gap-2 text-dark">
                        ...
                        <li className="nav-item">
                            <Link to={route('dashboard.articles.index')} className="nav-link d-flex align-items-center gap-2 text-dark">
                        ...
                        <li className="nav-item">
                            <Link to={route('dashboard.comment-replies.index')} className="nav-link d-flex align-items-center gap-2 text-dark">
                        ...
                        <li className="nav-item">
                            <Link to={route('dashboard.likes.index')} className="nav-link d-flex align-items-center gap-2 text-dark">
                    ...
                    <ul className="nav flex-column mb-auto">
                        <li 
                            className="nav-item" 
                            onClick={logoutUser}>
                            <a className="nav-link d-flex align-items-center gap-2 text-danger" href='#'>
